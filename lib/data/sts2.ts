...
export const sts2Secrets: Sts2Item[] = [
  ...
  },
  {
    ...
    category: "secret",
    alertType: "quest",
    alertDescription: "Sacrifier vos PV Max à cette entité est un choix irréversible pour le reste de la partie. Calculez bien votre survie.",
  ...
  },
  {
    ...
    category: "secret",
    alertType: "quest",
    alertDescription: "Détruire une de vos reliques sur cet autel est définitif. Ne sacrifiez pas une pièce maîtresse de votre build !",
  ...
  {
    id: "secret-fake-merchant",
    category: "secret",
    alertType: "item",
    alertDescription: "EASTER EGG : Conservez une 'Potion Fétide' (Foul Potion) jusqu'à l'Acte III. Si vous rencontrez l'événement du Faux Marchand et lui lancez la potion, un combat de boss secret s'enclenche ! Récompense : 300 Or et des fausses reliques exclusives.",
    title:         { fr: "Boss Secret : Le Faux Marchand",       en: "Secret Boss: The Fake Merchant"    },
    description:   { fr: "Un marchand suspect qui se révèle être un boss secret si vous lui lancez une Potion Fétide en Acte III.",
                     en: "A suspicious merchant who reveals himself as a secret boss if you throw a Foul Potion at him in Act III." },
    prerequisites: { fr: "Conserver une Potion Fétide (Foul Potion) jusqu'à l'Acte III.",
                     en: "Keep a Foul Potion until Act III." },
    howToUnlock:   { fr: "Tomber sur l'événement '?' du Faux Marchand en Acte III, puis lui lancer la Potion Fétide depuis votre inventaire.",
                     en: "Land on the Fake Merchant '?' event in Act III, then throw the Foul Potion from your inventory at him." },
    solution:      { fr: "La Potion Fétide est parfois proposée en récompense de combat. Ne la vendez pas ! Gardez-la précieusement pour Acte III. Ce boss a peu de PV mais attaque fort — préparez votre deck défensivement avant l'Acte III.",
                     en: "The Foul Potion is sometimes offered as a combat reward. Don't sell it! Keep it for Act III. This boss has low HP but hits hard — prepare your deck defensively before Act III." },
  },
];
...
export const sts2Relics: Sts2Item[] = [
  ...
  {
    id: "relic-tapis-marchand",
    category: "relic",
    alertType: "item",
    alertDescription: "Relique blague (Easter Egg) obtenue uniquement en battant le boss secret du Faux Marchand. Ne sert à rien, mais indispensable pour compléter le Compendium à 100% !",
    title:         { fr: "Tapis du Marchand ??? (Merchant's Rug)", en: "Merchant's Rug ???"              },
    description:   { fr: "Relique Easter Egg : n'a aucun effet en jeu, mais prouve que vous avez battu le boss secret du Faux Marchand.",
                     en: "Easter Egg relic: has no in-game effect, but proves you defeated the secret Fake Merchant boss." },
    prerequisites: { fr: "Vaincre le boss secret du Faux Marchand (voir la section Secrets).",
                     en: "Defeat the secret Fake Merchant boss (see the Secrets section)." },
    howToUnlock:   { fr: "Récompense unique du boss secret — non obtainable autrement.",
                     en: "Unique reward from the secret boss — not obtainable any other way." },
    solution:      { fr: "ASTUCE : Montrez ce tapis à vos amis pour prouver que vous avez découvert cet Easter Egg obscur. Si vous jouez pour le Compendium 100%, c'est une pièce obligatoire.",
                     en: "TIP: Show this rug to your friends to prove you found this obscure Easter Egg. If you're going for 100% Compendium, it's a mandatory piece." },
  },
  {
    id: "relic-cercueil-alchimique",
    category: "relic",
    alertType: "item",
    alertDescription: "Relique de rareté 'Ancienne' (Ancient). Extrêmement rare, elle remplit instantanément vos 4 emplacements de potions. Un sauveur de run.",
    title:         { fr: "Cercueil Alchimique (Alchemical Coffer)", en: "Alchemical Coffer"             },
    description:   { fr: "Relique Ancienne (Ancient) : remplit instantanément tous vos emplacements de potions lors de la récupération.",
                     en: "Ancient rarity relic: instantly fills all your potion slots upon pickup." },
    prerequisites: { fr: "Aucun prérequis — apparaît aléatoirement (rareté Ancient très faible).",
                     en: "No prerequisites — appears randomly (very low Ancient rarity drop rate)." },
    howToUnlock:   { fr: "S'obtient très rarement via les Boss d'Acte, les coffres dorés ou le Marchand spécial.",
                     en: "Very rarely obtained from Act Bosses, golden chests, or the special Merchant." },
    solution:      { fr: "PRIORITÉ ABSOLUE : Si cette relique apparaît chez un Boss ou un Marchand, achetez-la / choisissez-la systématiquement. 4 potions gratuites au moment de la prise est souvent équivalent à gagner un combat difficile d'avance.",
                     en: "ABSOLUTE PRIORITY: If this relic appears at a Boss or Merchant, always buy/pick it. 4 free potions on pickup is often equivalent to winning a difficult fight in advance." },
  },
  {
    id: "relic-etoile-noire",
    category: "relic",
    alertType: "item",
    alertDescription: "Objet unique de Boss qui modifie radicalement votre parcours : les Élites lâchent désormais une relique supplémentaire.",
    title:         { fr: "Étoile Noire (Black Star)",               en: "Black Star"                    },
    description:   { fr: "Relique de Boss : les Élites lâchent une relique supplémentaire pour le reste de la run.",
                     en: "Boss relic: Elites drop an extra relic for the rest of the run." },
    prerequisites: { fr: "Aucun prérequis — s'obtient comme récompense de Boss.",
                     en: "No prerequisites — obtained as a Boss reward." },
    howToUnlock:   { fr: "Proposée parmi les 3 reliques au choix après un combat de Boss.",
                     en: "Offered among the 3 choice relics after a Boss fight." },
    solution:      { fr: "IMPACT RUN : Avec l'Étoile Noire, cherchez activement les combats d'Élites sur la carte. Chaque Élite devient une source de relique supplémentaire, ce qui booste drastiquement la progression de votre build dès l'Acte I.",
                     en: "RUN IMPACT: With Black Star, actively seek Elite fights on the map. Every Elite becomes an extra relic source, drastically boosting your build progression from Act I." },
  },
];
